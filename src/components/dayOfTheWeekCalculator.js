...
export default class DayOfTheWeekCalculator extends React.Component {
  ...
  updateDayOfTheWeek = () => {
    ...
    console.log(dayIndex, this.DAYS_OF_THE_WEEK[dayIndex])
    this.setState(() => ({
  ...
  updateYearAndCenturyCodes = () => {
    ...
    console.log(`Year: ${this.state.year}, Last two numbers: ${lastTwoNumbers}, Century code: ${centuryCode}`)
  ...
  render() {
    return (
      <div>
        ...
        <h1>Day of the week: {this.dayOfTheWeek}</h1>
      </div>
    )
  }
}
